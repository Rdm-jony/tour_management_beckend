...
const createUser = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield user_service_1.userServices.creteUser(payload);
...
const getAllUser = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_service_1.userServices.getAllUser();
    (0, sendResponse_1.sendResponse)(res, {
        success: true,
...
exports.userControllers = { createUser, getAllUser, updateUser, getMe, getSingleUser };
