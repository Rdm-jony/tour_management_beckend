...
const initRePayment = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const bookingId = req.params.bookingId;
    const result = yield payment_service_1.paymentServices.initRePayment(bookingId);
...
exports.paymentController = { successPayment, cancelPayment, failPayment, initRePayment };
